...
An interactive **BlinkIT Grocery Sales & Analytics Dashboard** developed using **Microsoft Power BI** to analyze sales performance, outlet characteristics, item categories, customer ratings, outlet locations, fat content, and overall business KPIs.

The project transforms raw grocery sales data into an interactive business intelligence dashboard that helps identify **sales trends, high-performing outlets, product performance, outlet distribution, and key business insights**.

---

## 📊 Dashboard Preview

![BlinkIT Sales Dashboard](Images/BlinkIT-Dashboard-Overview.png)

---

## 🎯 Project Objective

The primary objective of this project is to analyze BlinkIT grocery sales data and build an interactive Power BI dashboard that provides meaningful insights into business performance.
...
|---|---:|---:|---:|---:|
| Supermarket Type1 | **$787.55K** | 5,577 | 141.21 | 3.96 |
| Grocery Store | **$151.94K** | 1,083 | 140.29 | 3.99 |
...
| Outlet Location Type | Tier classification of the outlet |
| Outlet Size | Size classification of outlet |
